<template>
  <div id="en_pronounce">
    ...
    <div class="audio_wrap">
      ...
      <div class="btn_wrap">
        <a href="javascript:void(0)" class="btn_icon micro" :class="{active:recordState}" @click="record">
        </a>
...
<script>
  ...
  export default {
    ...
    computed: {
      source() {
        return this.questionData.resource.source;
      }
    },
    methods: {
      audition() {
...
<style lang="stylus">
    ...
    .audio_wrap
      flex: 1
      background: linear-gradient(to top, rgba(255, 255, 255, 0.1), rgba(218, 181, 124, .2), rgba(255, 255, 255, 0.4))
      margin: 10px
      border-radius: 6px
