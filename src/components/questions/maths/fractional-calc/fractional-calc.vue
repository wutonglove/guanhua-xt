    ...
    <transition-group tag="ul" class="fractional_calc" name="slide">
      <li class="calc_step calc_step_1" key="step1" v-show="curIndex === 0">
        <div class="fractional_input_box">
          ...
          <input type="text" class="fractional_input" v-model="inputStr" maxlength="15" ref="equationInput" autofocus/>
                  ...
                  <div class="half" v-else>
                    <div class="num_box" v-if="Array.isArray(half)">
                      ...
                      >
                        ...
                        <span class="num" :class="{active:num.active}" @click="selected(num)" v-else>{{num.text * 1}}</span>
                      </div>
                    </div>
...
export default {
  ...
  computed: {
    ...
    clacResult() {
      let numerator =
        this.fractional1.split('/')[0] * this.multiple2 +
        this.fractional2.split('/')[0] * this.multiple1;
  ...
  methods: {
    ...
    next() {
      ...
      let reg2 = /\//g;
      let line =
        !this.inputStr.match(reg2) || this.inputStr.match(reg2).length < 2;
      let len = this.inputStr.match(reg1)
        ? this.inputStr.match(reg1).length
        : 0;
    ...
    inputLine() {
      ...
      let indexN1 = !(
        !this.inputStr[index - 1] || reg1.test(this.inputStr[index - 1])
      );
          ...
          .equation_item
            ...
            .fractional
              ...
              .num
                ...
                cursor: pointer
                border-radius: 4px
                box-shadow: inset 0 4px 13px rgba(255, 226, 181, 0.4), 1px 1px 8px rgba(68, 49, 19, 0.34)
              ...
              .line
                ...
                height: 2px
                background: #8d5d11
                box-shadow: 0.31px 0.53px 0 0 rgba(255, 255, 255, 0.294)
            .symbol
              display: inline-block
              width: 20px
              text-align: center
