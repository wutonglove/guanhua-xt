...
<script>
  ...
  export default {
    ...
    data() {
      this.$nextTick(() => {
        this.bdcss.maxW = parseInt(this.$refs.board.style.width) || this.$refs.board.offsetWidth;
        this.bdcss.maxH = parseInt(this.$refs.board.style.height) || this.$refs.board.offsetHeight;
      });
      return {
        chgSizeSte: false,
        bdMoveSte: false,
    ...
    methods: {
      mmove(e) {
        ...
        if (this.bdMoveSte) {
          ...
          let minT = 0;
          let minL = 0;
          let maxL = this.bdcss.maxW - (parseInt(this.$refs.board.style.width) || this.$refs.board.offsetWidth);
          let maxT = this.bdcss.maxH - (parseInt(this.$refs.board.style.height) || this.$refs.board.offsetHeight);
      ...
      chgSizeStart(e) {
        ...
        this.bdcss.w = parseInt(this.$refs.board.style.width) || this.$refs.board.offsetWidth;
        this.bdcss.h = parseInt(this.$refs.board.style.height) || this.$refs.board.offsetHeight;
      ...
      calcProportion() {
        ...
        let _h = parseInt(this.$refs.board.style.height) || this.$refs.board.offsetHeight;
